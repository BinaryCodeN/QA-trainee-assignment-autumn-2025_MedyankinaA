...
### Тест-кейсы:
Полное описание всех тест-кейсов и результатов можно найти в файле [TESTCASES.md](./TESTCASES.md)

### Баг-репорты:
Подробная информация о найденных и исправленных багах можно найти в файле [BUGS.md](./BUGS.md)